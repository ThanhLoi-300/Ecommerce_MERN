const styles = {
    ...
    productDiscountPrice:"font-bold text-[14px] text-[#333] font-Roboto w-full",
    price:"font-[500] text-[14px] text-[#d55b45] mt-[-4px] w-full line-through",
    ...
    button_cancel: 'w-[150px] bg-red-500 h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
  };
